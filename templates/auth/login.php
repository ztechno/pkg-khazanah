...
<head>
    ...
    WebFont.load({
        ...
        custom: {
            ...
            urls: ['<?=routeTo('assets/css/fonts.min.css')?>']
        },
        active: function() {
        ...
        <div class="row mt-4">
            <div class="col-sm-12 col-md-6 col-lg-4 mx-auto">
                <div class="card full-height">
                    ...
                    <div class="card-body">
                        <center>
                            <img src="<?=routeTo('assets/img/logokhazanah.png')?>" width="150px" height="100px"
                                alt="logo" style="object-fit:contain;">
                        </center>
                        <div class="card-title text-center">Login Form</div>
                        <div class="card-category text-center">Masukkan Username dan Password anda pada bidang di bawah
                            ini.</div>
                        ...
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" id="" class="form-control mb-2"
                                    placeholder="Nama Pengguna Disini...">
